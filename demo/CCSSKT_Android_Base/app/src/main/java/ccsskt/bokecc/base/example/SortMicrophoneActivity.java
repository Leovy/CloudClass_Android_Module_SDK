...
public class SortMicrophoneActivity extends BaseActivity {
    ...
    CCAtlasClient.OnNotifyStreamListener onNotifyStreamListener = new CCAtlasClient.OnNotifyStreamListener() {
        @Override
        public void onStreamAllowSub(final CCStream stream) {
            // 监听添加远程流;
    ...
    protected void onViewCreated() {
        ...
        showProgress();
        //开始进入房间
        ccAtlasClient.join(sessionid, userAccount, null, ccAtlasCallBack);
...
//                            unpublish();//停止推流
    ...
    public void closeLocalCameraStream() {
        if (mLocalStream == null || ccAtlasClient == null) {
            return;
        }
